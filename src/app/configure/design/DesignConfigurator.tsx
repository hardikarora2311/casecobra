...
import HandleComp from "@/components/HandleComp";
  ...
  async function saveConfig() {
    try {
      ...
      toast({
        ...
        description: "There was a problem saving your congif, please try again",
        variant: "destructive",
      });
    }
  }
      ...
      >
        ...
        <Rnd
          ...
          resizeHandleComponent={{
            bottomRight: <HandleComp />,
            bottomLeft: <HandleComp />,
            topRight: <HandleComp />,
            topLeft: <HandleComp />,
          }}
        >
                      ...
                      <div className="mt-3 space-y-4">
                        {selectableOptions.map((option) => (
                          <Radio
                            ...
                            className={({ checked, focus }) =>
                              cn(
                                "relative block cursor-pointer rounded-lg bg-white px-6 py-4 shadow-sm border-2 border-zinc-200 focus:ring-0 ring-0 outline-none focus:outline-none sm:flex sm:justify-between",
                                {
