...
const Thankyou = () => {
  ...
  //undefined is returned when the data is still loading as all other scenarios we have covered
  if (data === undefined) {
    return (
  ...
  const { billingAddress, configuration, shippingAddress, amount } = data;
