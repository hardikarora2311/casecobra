...
const OrderRecievedEmail = ({
  ...
  const baseUrl =
    process.env.NODE_ENV === "development"
      ? "http://localhost:3000"
      : "https://casecobra-live.vercel.app";
  return (
    <Html>
      <Head />
        ...
        <Container style={container}>
          <Section style={message}>
            <Img
              ...
              style={{ margin: "auto" }}
            />
            <Heading style={global.heading}>Thankyou for your order!</Heading>
          ...
          <Section style={global.defaultPadding}>
            ...
            <Text style={{ ...global.text, fontSize: 14 }}>
              ...
              {shippingAddress.state} {shippingAddress.postaCode}
            </Text>
          </Section>
          <Hr style={global.hr} />
          <Section style={global.defaultPadding}>
            <Row style={{ display: "inline-flex", marginBottom: 40 }}>
              ...
              <Column>
                <Text style={global.paragraphWithBold}>Date of purchase</Text>
          ...
          <Section style={paddingY}>
            <Row>
              ...
              >
                ...
                order. (If you reply to this email, we won't be able to see it.)
              </Text>
            </Row>
            <Row>
